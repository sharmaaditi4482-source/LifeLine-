...
export const translations = {
  en: {
    ...
    hero_cta_emergency: "Request Emergency Blood →",
    hero_cta_donor: "Register as Volunteer Donor",
  ...
  hi: {
    ...
    hero_cta_emergency: "आपातकालीन रक्त का अनुरोध करें →",
    hero_cta_donor: "रक्तदाता के रूप में पंजीकरण करें",
