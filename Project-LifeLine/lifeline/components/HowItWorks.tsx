      ...
      <div className="grid gap-8 md:grid-cols-3 relative">
        {[
          ...
          },
          {
            ...
            desc: "LifeLine filters out incompatibilities by calculating proximity, urgency, stock expiry, and donor reliability.",
          },
          {
            step: "03",
            label: "CONFIRM",
            title: "Lock Match",
            desc: "The top-ranked candidate is dispatched immediately. When confirmed, the first-confirmed lock activates and all other candidates are released.",
          },
        ].map((item) => (
