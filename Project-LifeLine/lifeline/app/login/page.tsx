...
export default function LoginPage() {
  ...
  const handleAuth = async (e: React.FormEvent) => {
    ...
    if (!isSupabaseConfigured) {
      setErrorText("Login is not configured yet. Add your Supabase URL and anon key to lifeline/.env.local, then restart the dev server.");
      setLoading(false);
      return;
    }
  ...
  const handleGoogleSignIn = async () => {
    ...
    if (!isSupabaseConfigured) {
      setErrorText("Google sign-in is not configured yet. Add your Supabase URL and anon key to lifeline/.env.local, then restart the dev server.");
      return;
    }
